...
namespace API.Features.Users
{
    internal sealed class UserRepository : Repository<User>, IUserRepository
    {
            ...
            await this.context.User
                  .Where(u =>
                      ...
                      u.date_of_birth <= (dataUserNowConnect.sex == "M" ?
                          dataUserNowConnect.date_of_birth.AddYears(10) :
                          dataUserNowConnect.date_of_birth.AddYears(1)) &&
                  !this.context.RequestFriends.Any(r =>
        ...
        public async Task<bool> GetUserByPseudoAsync(string Pseudo, CancellationToken cancellationToken) => await this.context.User.AnyAsync(u => u.Pseudo.ToLower() == Pseudo.ToLower(), cancellationToken);
        
        public async Task<User> GetUserWithCookieAsync(string token_session_user, CancellationToken cancellationToken) => await this.context.User.FirstOrDefaultAsync(u => u.token_session_user == token_session_user, cancellationToken);
